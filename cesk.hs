...
-- ((Lam ("z" :=> Ref "z")), fromList [], fromList [(1, Clo("z" :=> Ref "z", fromList []))], Ar((Lam ("a" :=> Ref "a")), fromList [], Mt))

-- ((Lam ("a" :=> Ref "a")), fromList [], fromList [(1, Clo("z" :=> Ref "z", fromList []))], Fn("z" :=> Ref "z", fromList [], Ar((Lam ("a" :=> Ref "a")), fromList [], Mt)))

-- (Ref "z", fromList [("z",2)], fromList [(1, Clo("z" :=> Ref "z", fromList [])), (2, Clo("a" :=> Ref "a", fromList []))], Ar((Lam ("a" :=> Ref "a")), fromList [], Mt))

-- ((Lam ("a" :=> Ref "a")), fromList [], fromList [(1, Clo("z" :=> Ref "z", fromList [])), (2, Clo("a" :=> Ref "a", fromList []))], Ar((Lam ("a" :=> Ref "a")), fromList [], Mt))

-- ((Lam ("a" :=> Ref "a")), fromList [], fromList [(1, Clo("z" :=> Ref "z", fromList [])), (2, Clo("a" :=> Ref "a", fromList []))], Fn("a" :=> Ref "a", fromList [], Mt))

-- (Ref "a", fromList [("a",1)], fromList [(1, Clo("z" :=> Ref "z", fromList [])), (2, Clo("a" :=> Ref "a", fromList [])), (3, Clo("a" :=> Ref "a", fromList []))], Mt)

-- (Lam ("z" :=> Ref "z"), fromList [], fromList [(1, Clo("z" :=> Ref "z", fromList [])), (2, Clo("a" :=> Ref "a", fromList [])), (3, Clo("a" :=> Ref "a", fromList []))], Mt)
